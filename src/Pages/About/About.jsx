        ...
        <>
            ...
            <div className="container mx-auto">
                ...
                <div className="mt-16 flex flex-col md:flex-row-reverse lg:flex-row-reverse mb-10 gap-8 h-[500px]">
                    <div className=" bg-red-300 h-[500px] lg:w-2/5 md:w-3/5 flex items-center justify-center bg-[url('https://i.ibb.co/T01wvfB/Commitment.jpg')] bg-center bg-cover bg-no-repeat" data-aos='fade-right' data-aos-duration = '1000' data-aos-delay='2000'>
                        <h1 className="text-5xl text-center text-white">Our Commitments</h1>
                    </div>
                    <div className="lg:w-3/5 md:w-4/5  flex items-center" data-aos='fade-left' data-aos-duration = '1000' data-aos-delay='2000'>
