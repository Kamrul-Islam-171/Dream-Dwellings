        ...
        <>
            ...
            <div className="container mx-auto">
                ...
                <div className="mt-16 space-y-8">
                    <h1 className="text-4xl text-center"  data-aos="zoom-in" data-aos-duration = '1000'>What Sets Us Apart</h1>
                    <div className="grid grid-cols-4 gap-8 ">
                        <div className="bg-secondary-color p-6 space-y-3 " data-aos="fade-up-left" data-aos-duration = '1000'
                        data-aos-delay='1000'>
                        ...
                        <div className="bg-third-color p-6 space-y-3 mt-4"
                        ...
                        <div className="bg-secondary-color p-6 space-y-3 mt-8"
                        ...
                        <div className="bg-third-color p-6 space-y-3 mt-12"
                ...
                <div className="mt-16 flex flex-row-reverse mb-10 gap-8 h-[500px]">
                    <div className=" bg-red-300 w-2/5 flex items-center justify-center bg-[url('https://i.ibb.co/T01wvfB/Commitment.jpg')] bg-center bg-cover" data-aos='fade-right' data-aos-duration = '1000' data-aos-delay='2000'>
                        <h1 className="text-5xl text-center text-white">Our Commitments</h1>
                    </div>
                    <div className="w-3/5  flex items-center" data-aos='fade-left' data-aos-duration = '1000' data-aos-delay='2000'>
                        <p className="text-justify text-xl">At Dream Dwellings, we understand that finding the right home is a deeply personal and significant decision. That's why we go above and beyond to provide you with the support, guidance, and expertise you need to make the best choice for you and your loved ones. With a focus on integrity, transparency, and exceptional customer service, we strive to make the process of buying or renting a home as smooth and enjoyable as possible.</p>
                    </div>
                </div>
            </div>
